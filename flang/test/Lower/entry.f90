...
subroutine ss(n1)
  ! CHECK-DAG: fir.alloca i32 {name = "n17"}
  ! CHECK-DAG: fir.alloca i32 {name = "n2"}
  ! CHECK-DAG: fir.alloca i32 {name = "n3"}
  ! CHECK-DAG: fir.alloca i32 {name = "nx"}
  ! CHECK-DAG: fir.alloca i32 {name = "ny"}
  integer n17, n2
  nx = 100
  n1 = nx + 10
  return
...
entry e1(n2, n17)
  ! CHECK-DAG: fir.alloca i32 {name = "n1"}
  ! CHECK-DAG: fir.alloca i32 {name = "n3"}
  ! CHECK-DAG: fir.alloca i32 {name = "nx"}
  ! CHECK-DAG: fir.alloca i32 {name = "ny"}
  ny = 200
...
function jj(n1)
  ! CHECK-DAG: fir.alloca i32 {name = "n2"}
  ! CHECK-DAG: fir.alloca i32 {name = "jj"}
  jj = 100
  jj = jj + n1
  return
