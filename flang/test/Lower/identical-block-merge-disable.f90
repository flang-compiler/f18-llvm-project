...
! CHECK:         %[[VAL_9:.*]] = cmpi eq, %[[VAL_8]], %[[VAL_4]] : i32
...
! CHECK:         %[[VAL_22:.*]] = cmpi ne, %[[VAL_21]], %[[VAL_2]] : i64
...
! CHECK:         %[[VAL_46:.*]] = subi %[[VAL_45]], %[[VAL_4]] : i32
...
! CHECK:         %[[VAL_59:.*]] = cmpi ne, %[[VAL_58]], %[[VAL_2]] : i64
...
! CHECK:         %[[VAL_65:.*]] = subi %[[VAL_63]], %[[VAL_64]] : i64
...
! CHECK:         %[[VAL_76:.*]] = subi %[[VAL_74]], %[[VAL_75]] : i64
...
! CHECK:         %[[VAL_83:.*]] = subi %[[VAL_82]], %[[VAL_4]] : i32
