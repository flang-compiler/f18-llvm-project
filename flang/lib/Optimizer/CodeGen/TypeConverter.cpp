...
LLVMTypeConverter::LLVMTypeConverter(mlir::ModuleOp module)
  ...
  addConversion([&](mlir::NoneType none) {
    return mlir::LLVM::LLVMStructType::getLiteral(none.getContext(), llvm::None,
                                                  /*isPacked=*/false);
  });
...
mlir::Type LLVMTypeConverter::convertBoxType(BoxType box, int rank) {
...
mlir::Type LLVMTypeConverter::convertBoxTypeAsStruct(BoxType box) {
...
mlir::Type LLVMTypeConverter::convertComplexPartType(fir::KindTy kind) {
...
// the command line.)
mlir::Type LLVMTypeConverter::getDefaultInt() {
  return mlir::IntegerType::get(
      &getContext(),
...
mlir::Type LLVMTypeConverter::convertRecordType(fir::RecordType derived) {
...
mlir::Type LLVMTypeConverter::fromRealTypeID(llvm::Type::TypeID typeID,
                                             fir::KindTy kind) {
  switch (typeID) {
...
KindMapping &LLVMTypeConverter::getKindMap() { return kindMapping; }
